%Gradient descent and Gauss-Newton nonlinear optimization technique to
%calculate the position of a receiver on earth to high accuracy, when
%the receiver clock is not accurate.
%
% Inputs
%
%    none
